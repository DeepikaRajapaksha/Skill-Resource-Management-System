// src/pages/PersonnelSkill/Create.jsx
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error(err);
        alert("Failed to load personnel or skills.");
      }
    };
    fetchData();
  }, []);
  ...
  return (
    <div className="personnel-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label>Skill *</label>
          <select name="skill_id" className="form-input" value={form.skill_id} onChange={handleChange}>
        ...
        <div className="form-group">
          ...
          <select name="proficiency" className="form-input" value={form.proficiency} onChange={handleChange}>
        ...
        <button className="btn-submit" type="submit">Assign Skill</button>
      </form>
    </div>
  );
}
